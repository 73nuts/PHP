...
while ($rs = mysqli_fetch_array($res)) {
    ?>
		<tr class="text-c">
					...
					<td>No.<?php echo str_pad($i,5,"0",STR_PAD_LEFT);?></td>
					...
					<i class="Hui-iconfont">&#xe6df;</i></a>
					<a style="text-decoration:none" class="ml-5" onClick="article_del(this,'10001')" href="del.php?id=<?php echo $rs['id'];?>" title="删除">
